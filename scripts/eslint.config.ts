/**
 * Strict syntax and correctness policy for every repository TypeScript file.
 *
 * Babel supplies the ESTree parser because the current TypeScript compiler is
 * newer than typescript-eslint's supported peer range. TypeScript remains the
 * authoritative build and type-check compiler.
 */
...
export default defineConfig([
  {
    ignores: [".agents/**", "coverage/**", "dist/**", "dist-test/**", "node_modules/**"],
  },
  {
    files: ["**/*.ts"],
    languageOptions: {
