...
- Adopt the canonical docstring gate, blocked on a pm-ops release carrying the .agents skip ([pm-csv-hi55](https://github.com/unbraind/pm-csv/blob/main/.agents/pm/tasks/pm-csv-hi55.toon))
