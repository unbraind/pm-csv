...
- Gate CI on pm health for tracker integrity (does not cover discarded peer edits, see pm-cli 922) ([pm-csv-c8j4](https://github.com/unbraind/pm-csv/blob/main/.agents/pm/chores/pm-csv-c8j4.toon))
